...
public class GeneratePieChartUtil {
    ...
    public static JFreeChart createPieChart(String chartTitle, List<String> legendNameList, List<Object> dataList,
        ...
        //创建饼图
        JFreeChart chart =
            ChartFactory.createPieChart(chartTitle, JFreeChartUtil.createDefaultPieDataset(legendNameList, dataList));
        // 设置抗锯齿，防止字体显示不清楚
     ...
     * @return
     */
    public static byte[] createPieChart(String chartTitle, List<String> legendNameList, List<Object> dataList,
        int width, int height, StandardChartTheme theme, List<Color> legendColorList, List<Double> explodePercentList)
        throws Exception {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            createPieChart(baos, chartTitle, legendNameList, dataList, width, height, theme, legendColorList,
                explodePercentList);
     ...
     * @return
     */
    public static void createPieChart(OutputStream outputStream, String chartTitle, List<String> legendNameList,
        List<Object> dataList, int width, int height, StandardChartTheme theme, List<Color> legendColorList,
        List<Double> explodePercentList) throws Exception {
        JFreeChart chart =
            createPieChart(chartTitle, legendNameList, dataList, theme, legendColorList, explodePercentList);
        try {
     ...
     * @return
     */
    public static JFreeChart create3DPieChart(String chartTitle, List<String> legendNameList, List<Object> dataList,
        ...
        //创建饼图
        JFreeChart chart =
            ChartFactory.createPieChart3D(chartTitle, JFreeChartUtil.createDefaultPieDataset(legendNameList, dataList),
                true, true, true);
        // 设置抗锯齿，防止字体显示不清楚
        chart.setTextAntiAlias(false);
        // 设置标注无边框
     ...
     * @return
     */
    public static byte[] create3DPieChart(String chartTitle, List<String> legendNameList, List<Object> dataList,
     ...
     * @return
     */
    public static void create3DPieChart(OutputStream outputStream, String chartTitle, List<String> legendNameList,
        List<Object> dataList, int width, int height, StandardChartTheme theme, float alpha,
        List<Color> legendColorList) throws Exception {
