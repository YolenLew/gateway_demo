...
public class JFreeChartUtil {
     ...
     * @return
     */
    public static DefaultCategoryDataset createDefaultCategoryDataset(List<String> legendNameList,
        List<String> xAxisNameList, List<List<Object>> dataList) {
        ...
        for (int yAxisIndex = 0;
             yAxisIndex < legendNameList.size() && legendNameList.size() == dataList.size(); yAxisIndex++) {
